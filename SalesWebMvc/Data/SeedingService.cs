...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d3 = new Department(new int(), "Books");
            Department d4 = new Department(new int(), "Tools");

            Seller s1 = new Seller(new int(), "Bob Brown", "bob@gmail.com", new DateTime(1990, 2, 19), 1200.00, d1);
            Seller s2 = new Seller(new int(), "Maria Green", "maria@gmail.com", new DateTime(1979, 7, 9), 3200.00, d2);
            Seller s3 = new Seller(new int(), "Alex Gray", "alex@gmail.com", new DateTime(1992, 9, 26), 1000.00, d4);
            Seller s4 = new Seller(new int(), "Martha Red", "martha@gmail.com", new DateTime(1986, 11, 21), 2200.00, d4);
            Seller s5 = new Seller(new int(), "Donald Blue", "donald@gmail.com", new DateTime(1989, 12, 3), 2000.00, d2);
            Seller s6 = new Seller(new int(), "Alex Pink", "alexP@gmail.com", new DateTime(1993, 5, 5), 1000.00, d3);
